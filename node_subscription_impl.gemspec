require_relative './lib/node_subscription_impl/version'

Gem::Specification.new do |spec|

  # Required attributes.
  spec.name                  = "node_subscription_impl"
  spec.version               = NodeSubscription::VERSION
  spec.authors               = ["Diligent Software LLC"]
  spec.email                 = ["contact@diligentsoftware.org"]
  spec.summary               = %q{A NodeSubscription library implementation.}
  spec.description           = %q{A NodeSubscription library implementation.
...
Greatly appreciated.}
  spec.homepage              =
      "https://docs.diligentsoftware.org/subscription-1/node/implementation"
  ...
  spec.metadata['source_code_uri'] =
      "https://github.com/Diligent-Software-LLC/node_subscription_impl"
